 ...
 */
final class Version20200207031402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD comptes_env_id INT NOT NULL, ADD comptes_ret_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transaction_compte (transaction_id INT NOT NULL, compte_id INT NOT NULL, INDEX IDX_B98B20202FC0CB0F (transaction_id), INDEX IDX_B98B2020F2C56620 (compte_id), PRIMARY KEY(transaction_id, compte_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE transaction DROP comptes_env_id, DROP comptes_ret_id');
    }
}
