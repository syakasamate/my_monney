 ...
 */
final class Version20200203194018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partenaire ADD CONSTRAINT FK_32FFA37367B3B43D FOREIGN KEY (users_id) REFERENCES partenaire (id)');
